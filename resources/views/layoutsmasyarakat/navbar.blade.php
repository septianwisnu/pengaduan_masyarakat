    ...
    <div class="branding d-flex align-items-center">
        ...
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li>
                        <a href="{{ Auth::check() ? url('/dashboardmasyarakat') : url('/') }}" 
                        class="{{ request()->is('/') || request()->is('dashboardmasyarakat') ? 'active' : '' }}">
                        Home
                     </a>
                    ...
                    @else
                        <li>
                            <a href="{{ route('dashboard_masyarakat.profile') }}" 
                               class="{{ request()->is('dashboard_masyarakat/profile') ? 'active' : '' }}">Profile</a>
                        </li>
